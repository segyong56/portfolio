      ...
      <Section2>
        <SefieDescription>
          <p>
            ...
            <strong>"작업치료사이자 프론트엔드 개발자"</strong>입니다. 네, 저는
            <span className='strong'>
              새로운 도전을 두려워하지만 두려워하지 않는 사람
            </span>
            입니다. 저에게 두려움을 주었던 부분은 자신이 성장하기 위해서 얼마나
            많은 노력을 해야하는지 어떤 어려움이 있어도 포기하지 않아야 한다는걸
            잘 알고 있었기 때문입니다. 하지만 두려워하지 않는 사람인 이유는
            저에게 주는 두려움을 노력으로 이겨내고 개발자 되었기 때문이라고
            생각합니다. 앞으로 저는 제가 작업치료사로서 일한 경험을 토대로 몸이
            불편하신 분들이 느끼는 불편함 점을 잘 생각해서, 신체적 장애가
            있으셔도 또 앱을 사용하는데있어 어려움을 느끼는시는 노인분들께서도
            서비스를 이용하는데 불편함이 없는 서비스를 개발하는, 유저입장을
            생각하는 개발자가 되고 싶은 개발자 입니다.
          </p>
        </SefieDescription>
      </Section2>
        ...
        <Answer>
          ...
          <div>
            <p>
              ...
              무엇인지에 대해서 많은 고민을 했던 저에게 어둠 속 한 줄기의 빛처럼
              찾아왔던 직업이 개발자였습니다. <br />
              ...
              실현가능하게 만든다는 매력적인 점이 개발자라는 직업을 하고 싶다고
              생각하게 하였고, 생각이 많은 저에게 제가 가장 잘할 수 있는 일,
              생각하기를 많이 하는 개발자를 하면 잘할수 있을 것 같다는 생각을
              하게 되었습니다. 그렇게 개발자가 되어야겠다고 생각하게 되었고,
              개발자가 되기 위해 인생도전기가 시작되었답니다.
            </p>
          </div>
        </Answer>
      </QuestionBox>
      ...
      <QuestionBox>
        ...
        <Answer>
          <p>
            ...
            토대로 신체적 장애가 있을 때 어떠한 불편함이 있는지를 생각하며 모든
            유저가 서비스 사용하는 데 있어 좀 더 쉽고 편리하게 기능을 구현하기가
            첫번째 목표입니다.
            <br />
            <br />
            <span className='strong_1'>두번째, </span> 몸이 불편하시분들을 위한
            서비스를 만들어 보고 싶습니다. 구체적으로는 택시를 부르는 앱은
            시중에 많이 있습니다. 하지만 신체적 장애가 있으신 분들 혹은
            노인분들이 사용하기에 편한지 한번 생각해보면 사용하기에 많은 부분이
            어렵습니다. 몸이 불편하신 분들을 도와주는 서비스를 포함한다면 좀 더
            많은 사람들이 이용할 수 있지 않을까 생각해 보았습니다. 이러한
            불편함을 편리하게 만들어주는 서비스를 개발하는 것이 두번째
            목표입니다.
            <br />
            <br />
            <strong>
